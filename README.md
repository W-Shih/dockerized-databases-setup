...
- [Docker commands and provisioning scripts for PostgreSQL 14.2](./docs/pg-docker-commands.md)
- [Setting Up PostgreSQL 14.2 with Dockerfile](./docs/pg-dockerfile.md)
...
- [Docker commands and provisioning scripts for MS-SQL 2019](./docs/ms-sql-docker.md)

### Oracle 19c standard with docker container and volume [[↑](#dockerized-databases-setup)]

- [Docker commands and provisioning scripts for Oracle 19c standard](./docs/oracle-docker.md)
